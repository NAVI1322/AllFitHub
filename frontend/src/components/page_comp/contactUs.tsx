      ...
      <div className="bg-black text-white dark:bg-slate-100">
        <div className="container px-6 py-12 mx-auto">
          <div className="text-center">
            ...
            <h1 className="mt-2 text-2xl font-semibold md:text-3xl dark:text-black">Get in touch</h1>
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center">
              <span className="p-3 text-gray-400 rounded-full bg-gray-800">
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-gray-400">+1 (647) 482 4537</p>
            </div>
          </div>
        </div>
      </div>
