...
const TeamCard =  ( {member}:TeamCardProps) => {
    ...
    const { name,ProfilePicture,role,twitter,github,linkedin }:TeamMember = member;
    ...
    return (
                <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img className="w-52 rounded-lg sm:rounded-none sm:rounded-l-lg " src="" alt="Bonnie Avatar" />
                    </a>
                    <div className="p-5">
                        ...
                        <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Work that he has Done</p>
